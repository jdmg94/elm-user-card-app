...
var author$project$Types$User = F4(
	function (firstName, lastName, username, picture) {
		return {firstName: firstName, lastName: lastName, picture: picture, username: username};
	});
...
var author$project$Tasks$getRandomProfile = elm$http$Http$get(
	{
		expect: A2(elm$http$Http$expectJson, author$project$Types$GotUser, author$project$Tasks$resultsDecoder),
...
var author$project$Types$Fail = {$: 'Fail'};
						...
						return author$project$Styles$card(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											author$project$Styles$roundedImage(profile.picture)
										])),
