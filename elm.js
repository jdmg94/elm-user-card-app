...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.j, request.aT, true);
		} catch (e) {
...
var author$project$Types$User = F4(
	function (firstName, lastName, username, picture) {
		return {aB: firstName, aG: lastName, aL: picture, aU: username};
	});
...
var author$project$Tasks$userDecoder = A2(
...
var author$project$Tasks$resultsDecoder = A2(
	elm$json$Json$Decode$field,
	'results',
	A2(elm$json$Json$Decode$index, 0, author$project$Tasks$userDecoder));
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{z: false, av: r.av, az: r.az, f: r.f, j: r.j, k: r.k, m: r.m, aT: r.aT}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{av: elm$http$Http$emptyBody, az: r.az, f: _List_Nil, j: 'GET', k: elm$core$Maybe$Nothing, m: elm$core$Maybe$Nothing, aT: r.aT});
};
var author$project$Tasks$getRandomProfile = elm$http$Http$get(
	{
		az: A2(elm$http$Http$expectJson, author$project$Types$GotUser, author$project$Tasks$resultsDecoder),
		aT: 'https://randomuser.me/api'
	});
var author$project$Types$Loading = {$: 0};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(author$project$Types$Loading, author$project$Tasks$getRandomProfile);
};
...
var author$project$Types$Fail = {$: 1};
		...
		if (!msg.$) {
			...
			if (!result.$) {
				...
				return _Utils_Tuple2(
					author$project$Types$Success(profile),
					elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(author$project$Types$Fail, elm$core$Platform$Cmd$none);
			}
		}
	});
...
var author$project$Styles$card = elm$html$Html$div(
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('flex bg-white rounded-lg shadow-lg p-4')
		]));
var author$project$Styles$container = elm$html$Html$div(
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('flex flex-1 flex-col items-center justify-center h-full')
		]));
var author$project$Styles$detail = elm$html$Html$div(
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('md:ml-4 flex flex-col justify-center')
		]));
var elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var elm$html$Html$Attributes$style = elm$virtual_dom$VirtualDom$style;
var author$project$Styles$loader = elm$html$Html$div(
	_List_fromArray(
		[
			A2(elm$html$Html$Attributes$style, 'border', '4px solid #0000'),
			A2(elm$html$Html$Attributes$style, 'border-top', '4px solid #38A169'),
			elm$html$Html$Attributes$class('w-20 h-20 rounded-full shadow spins')
		]));
var author$project$Styles$onTheLeft = elm$html$Html$div(
	_List_fromArray(
		[
...
var author$project$Styles$roundedImage = function (url) {
	return A2(
		elm$html$Html$img,
		_List_fromArray(
			[
				elm$html$Html$Attributes$class('rounded-full m-2'),
...
var author$project$Styles$title = function (message) {
	return A2(
		elm$html$Html$p,
		_List_fromArray(
			[
...
var author$project$Types$AnotherOne = {$: 0};
...
var author$project$Main$view = function (model) {
	return author$project$Styles$container(
		_List_fromArray(
			[
				function () {
				switch (model.$) {
					case 0:
						return author$project$Styles$loader(_List_Nil);
					case 1:
						return author$project$Styles$loader(_List_Nil);
					default:
						var profile = model.a;
						return author$project$Styles$card(
							_List_fromArray(
								[
									author$project$Styles$onTheLeft(
									_List_fromArray(
										[
											author$project$Styles$roundedImage(profile.aL)
										])),
									author$project$Styles$detail(
									_List_fromArray(
										[
											author$project$Styles$title(profile.aB + (' ' + profile.aG)),
											author$project$Styles$subtitle('@' + profile.aU),
											A2(
...
var author$project$Main$main = elm$browser$Browser$element(
	{aF: author$project$Main$init, aQ: author$project$Main$subscriptions, aS: author$project$Main$update, aV: author$project$Main$view});
